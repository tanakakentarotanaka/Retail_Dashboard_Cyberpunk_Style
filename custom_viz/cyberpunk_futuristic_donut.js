 ...
 * (Added Leader Line Font Size & Value Display Options)
 */
...
looker.plugins.visualizations.add({
  ...
  updateAsync: function(data, element, config, queryResponse, details, done) {
    ...
    // 文字サイズによって余白を微調整
    const leaderFontSize = config.leaderLineFontSize || 11;
    ...
    if (showLeaderLines) {
      ...
      const contentMode = config.leaderLineContent || "both"; // percent, value, both
      ...
      lines.append("text")
        ...
        .style("font-size", leaderFontSize + "px") // 設定したフォントサイズ
        ...
        .each(function(d) {
           ...
           el.append("tspan")
             ...
             .style("font-size", (leaderFontSize - 1) + "px"); // メインより少し小さく
        });
    }
